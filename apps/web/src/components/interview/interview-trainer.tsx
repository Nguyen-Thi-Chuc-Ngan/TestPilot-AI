...
const SAMPLE_QUESTIONS: Question[] = [
  { id: 'q1', question: 'What is the difference between severity and priority in bug reporting?', category: 'fundamentals' },
  { id: 'q2', question: 'Describe your process for writing a test case from scratch.', category: 'test-design' },
  { id: 'q3', question: 'How do you decide what to test when you have limited time before a release?', category: 'strategy' },
  { id: 'q4', question: 'What is boundary value analysis and when would you use it?', category: 'techniques' },
  { id: 'q5', question: 'How would you test a login form?', category: 'practical' },
    ...
    <div className="space-y-6">
      ...
      {!question ? (
        <div className="rounded-xl border border-dashed border-border p-12 text-center">
          <p className="text-muted-foreground mb-4">Ready to practice your QA interview skills?</p>
          <button
        ...
        <div className="space-y-4">
          ...
          {!feedback && (
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
              <textarea
                {...register('answer', { required: 'Please write your answer' })}
                rows={6}
